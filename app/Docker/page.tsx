	...
	return (
		<div className='grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16  font-[family-name:var(--font-geist-sans)]'>
			<main className='flex flex-col gap-[32px] row-start-2 items-center sm:items-start'>
				<h1 className='text-3xl text-[#0db7ed] bold'>Docker</h1>

				<div className='flex gap-4 items-center flex-col sm:flex-row'>
					<Link
						href='/Docker/DockerBeginner'
						className='rounded-full border border-[#0db7ed] transition-colors flex items-center justify-center hover:bg-[#5B9BD5] dark:hover:text-black hover:border-transparent font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto '>
						Beginner
					</Link>
					<Link
						...
						href='/Docker/DockerIntermediate'>
						Intermediate
					</Link>
